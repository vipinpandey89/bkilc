...
@section('content')
  ...
  <div id="Banner_wrapper" class="bg-parallax" style="background-image:url({{url('website/images/card-dark.jpg')}});">
  <div id="Subheader">
   <div class="container">
...
<!--- The project --->
 ...
 <img src="{{url('website/images/overspending.jpg')}}" class="img-responsive" alt="">
 </div>
 </div>
 </div>
 <div class="col-lg-6 col-md-6 col-sm-12">
...
<p>Pensa a quante cose puoi fare con i soldi risparmiati, un <b>viaggio</b>, un <b>corso </b>per te o per i figli, un regalo importante <b>per chi ami</b>?</p>
 ...
 <div class="row image_frame">
 <div class="image_wrapper">
 <img src="{{url('website/images/cashback.jpg')}}" class="img-responsive" alt="">
 </div>
 </div>
 </div>
 </div>
