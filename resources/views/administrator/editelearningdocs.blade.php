						...
						<div class="form-body">
						 ...
						 {{ csrf_field() }}
							<div class="form-group {{ $errors->has('filename') ? ' has-error' : '' }}">
								 ...
								 <input type="text" title="Nome del file" class="form-control" id="filename" name="filename" value="{{!empty($getDetail)?$getDetail->file_name:old('filename')}}" placeholder="Nome del file" value="{{Session::get('name') }}">
							...
							<div class="form-group {{ $errors->has('editor1') ? ' has-error' : '' }}">
								 ...
								 <textarea class="form-control" name="editor1"  placeholder="Descrizione">{{old('editor1')}}{{!empty($getDetail)?$getDetail->description:''}}</textarea>
							...
							<div class="form-group {{ $errors->has('point_value') ? ' has-error' : '' }}">
								 ...
								 <input type="text" title="Punto Valore" class="form-control" id="point_value" value="{{!empty($getDetail)?$getDetail->point_value:old('point_value')}}" name="point_value" placeholder="Eg. 23" value="{{Session::get('point_value') }}">
							...
							<div class="form-group {{ $errors->has('file') ? ' has-error' : '' }}">
								 ...
								 @if ($errors->has('file'))
                                   ...
                                   <input type="hidden" name="olde_value" value="{{$getDetail->file}}">
							</div>
