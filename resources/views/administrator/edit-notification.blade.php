						...
						<div class="form-body">
							...
							<div class="form-group {{ $errors->has('type_notification') ? ' has-error' : '' }}">
								 ...
								 <select class="form-control" id="type_notification" name="type_notification">
								 		...
								 		<option value="1"{{($getEditNotification->reminder_type=='1')?'selected':''}}>Aggiornamento</option> 
								 		<option value="2" {{($getEditNotification->reminder_type=='2')?'selected':''}}>scadenza card</option>							 		
