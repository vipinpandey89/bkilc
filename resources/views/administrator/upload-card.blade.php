                            ...
                            <ul>
                               ...
                               <span><i class="fa fa-angle-right" aria-hidden="true"></i></span>
                                <li><a href="{{url('administrator/list-card')}}">carica la carta digitale</a></li>
                                 ...
                                 <span><i class="fa fa-angle-right" aria-hidden="true"></i></span>
                                <li><a class="current" href="#">Aggiungi carta</a></li>
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							...
							<div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
								 ...
								 <input type="text" class="form-control" id="title" name="title" placeholder="Nome" value="{{ old('title') }}">
								 @if ($errors->has('title'))
							...
							<div class="form-group {{ $errors->has('image') ? ' has-error' : '' }}">
								 ...
								 <input type="file" class="form-control" id="image" name="image" placeholder="Immagine">
							...
							<div class="form-group {{ $errors->has('amount') ? ' has-error' : '' }}">
								 ...
								 <input type="text" class="form-control" id="amount" name="amount" placeholder="Importo della carta" value="{{ old('amount') }}">
							...
							<div class="form-group {{ $errors->has('card_length') ? ' has-error' : '' }} monthclass">
								 <label for="card_length">lunghezza della carta (Mese)</label> <input type="checkbox" name="month" id="monthid" >
								 <input type="number" class="form-control" id="card_length" name="card_length" style="display:none;" placeholder="lunghezza della carta (Mese)" value="{{ old('card_length') }}"  min="1" max="12">
							...
							<div class="form-group {{ $errors->has('card_length_days') ? ' has-error' : '' }} daysclass">
								 <label for="card_length_days">lunghezza della carta (giorni)</label> <input type="checkbox" name="days" id="daysid" > 
								 <input type="number" class="form-control" id="card_length_days" name="card_length_days" style="display:none;" placeholder="lunghezza della carta (giorni)" value="{{ old('card_length_days') }}"  min="1" max="29">
							...
							<div class="form-group {{ $errors->has('editor1') ? ' has-error' : '' }}">
							  ...
							  <button type="submit" class="btn btn-default" name="addbutton">Crea</button> </form> 
						</div>
					</div>											
				</div>
			</div>
