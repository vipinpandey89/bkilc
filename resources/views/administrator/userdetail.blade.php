                    ...
                    <div class="col-md-4 text-right">
                        <div class="breadcumb">
                            <ul>
                               ...
                               <span><i class="fa fa-angle-right" aria-hidden="true"></i></span>
                                <li><a  href="{{url('administrator/userlist')}}">Lista utenti</a></li>
                    ...
                    <div class="col-md-12">
                          @if(!empty($userDetail))
                                  ...
                                  <div class="tree">
                                      <ul>
                                        <li>
                                          <a href="#"  class="chlid" data-id="{{$userDetail->id}}">
                                              <div class="user-img">
    ...
    <div class="modal-content">
     ...
     <div class="modal-body">
               ...
               <?php if(!empty($userDetail->profileimage)){?>
                ...
                <div class="Phone">
                    <span>Phone</span>:- {{!empty($userDetail->telephoneNumber)?$userDetail->telephoneNumber:''}}
                </div>
                <div class="dob">
                    <span>DBO</span>:-  {{!empty($userDetail->dob)?$userDetail->dob:''}}
                </div>
                <div class="c-level">
                    <span>Current-Level</span>:- {{!empty($userDetail->user_as)?$userDetail->user_as:''}}
                </div>
     </div>   
