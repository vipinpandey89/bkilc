			  ...
			  @if (Session::has('success'))
                ...
                @endif
                    ...
                    <th>Azione</th>
						 	...
						 	<tbody>
						 		<?php $i=1; ?>
						 		@foreach($getAffiliatesSubscription as $user)
                <?php $getUser = Helper::getUserByUserId($user->parent_id);
                 ...
                 ?>
							       ...
							       <td>{{($user->paymentstatus)?$user->paymentstatus:'Gratis'}}</td> 
					 ...
					 <td>
					 @if(empty($user->isPromotor))
								   <a class="btn btn-info btn-sm" href="{{url('administrator/editAff/'.$user->id)}}" title="modificare"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>  
					@endif		      
