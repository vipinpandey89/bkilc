					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							...
							<div class="form-group {{ $errors->has('businessname') ? ' has-error' : '' }}">
								 ...
								 <input type="text" class="form-control" id="exampleInputEmail1" name="businessname" value="{{ !empty($userProfile)?$userProfile->userName:old('businessname')}}" placeholder="Nome della ditta" maxlength="30">
							...
							<div class="form-group{{ $errors->has('telephoneNumber') ? ' has-error' : '' }}">
								 ...
								 <input type="text" class="form-control" id="exampleInputEmail1" min="1" max="10" name="telephoneNumber"  value="{{ !empty($userProfile)?$userProfile->telephoneNumber:old('telephoneNumber')}}" placeholder="Telephone Number">
							...
							<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
								 ...
								 <input type="email" class="form-control" id="exampleInputEmail1" name="email" value="{{!empty($userProfile)?$userProfile->email:old('email')}}"  placeholder="E-Mail Address">
							...
							<div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
								 ...
								 <input type="text" class="form-control" id="adr" name="address"  value="{{ !empty($userProfile)?$userProfile->telephoneNumber:old('address')}}" placeholder="Indirizzo">
							...
							<div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
								 ...
								 <input type="text" class="form-control" id="city" name="city"  value="{{ !empty($userProfile)?$userProfile->telephoneNumber:old('city')}}" placeholder="Città">
							...
							<div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
								 ...
								 <input type="text" class="form-control" id="state" name="state"  value="{{ !empty($userProfile)?$userProfile->telephoneNumber:old('state')}}" placeholder="Stato">
							...
							<div class="form-group{{ $errors->has('postalCode') ? ' has-error' : '' }}">
								 ...
								 <input type="text" class="form-control" id="zip" name="postalCode" value="{{ !empty($userProfile)?$userProfile->postalCode:old('postalCode')}}" placeholder="Postal Code">
