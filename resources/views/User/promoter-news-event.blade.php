                    ...
                    <div class="col-md-4 text-right">
                        <div class="breadcumb">
                            <ul>
                                ...
                                <li><a class="current" href="{{url('new-event-promoter')}}">News & eventi</a></li>
                            ...
                            <div class="table-responsive">
                                <table class="table user-data-table table-striped table-bordered table-hover table-green" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $i='1';?>
                                        @foreach($newsEvent as $detail)
                                        <?php $des = substr($detail->description,0,200);?>
                                           
                                        <tr class="odd gradeX">
                                            <td>{{$i}}</td>
                                                                                           
                                            <td><a href="{{url('news-detail/'.$detail->id)}}">{{$detail->title}}</a></td>
                                             <td>{{strip_tags($des)}}</td> 
                                             <td><label class="label label-warning">{{date('d-m-Y',strtotime($detail->start_time))}}</label></td>
