...
@section('content') <div id="Banner_wrapper" class="bg-parallax category-news" style="background-image:url({{url('website/images/fascione-news.jpg')}});">
            <div id="Subheader">
                <div class="container">
        ...
        <div id="Content">
            ...
            <section class="contact-sec">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="image_wrapper"><img class="scale-with-grid" src="{{url('website/css/home_meeting_contact1.png')}}" alt=""></div>
