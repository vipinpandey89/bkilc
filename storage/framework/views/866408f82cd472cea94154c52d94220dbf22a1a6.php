...
<div class="container">
  <div class="row">
    <div class="col-md-12 ">
      <!-- <h2><a href="<?php echo e(url('/')); ?>">Home</a></h2> -->
      <h2> Checkout</h2>
    </div>
    <div class="col-md-8">
...
<div class="row">
  ...
  <div class="col-md-4">
    ...
    <div class="cart-summary">
      <h4>Carrello <span class="price" style="color:black"><i class="fa fa-shopping-cart"></i> <b><?php echo e(count($cartDetail)); ?></b></span></h4>

     <?php  $total='0';
          $arrId = array();
      ?>
      <?php $__currentLoopData = $cartDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php  $total = $total+ $detail->price;
                array_push($arrId,$detail->id);
       ?>
           <p><a href="<?php echo e(url('card-detail/'.$detail->id)); ?>"><?php echo e($detail->name); ?></a> <span class="price">&euro;<?php echo e($detail->price); ?></span></p>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    
 
      <hr>
      <p>Totale <span class="price" style="color:black"><b>&euro;<?php echo e($total); ?></b></span></p>
            ...
            <input type="hidden" id="amount" name="amount" value="<?php echo e(!empty($cartDetail)?$total:''); ?>">
            <input type="hidden" name="currency_code" value="EUR">    
            <input type="hidden" name="custom" id="custom" value="">                                        
            <input type='hidden' name='cancel_return' value='<?php echo e(url('paypal/cancel')); ?>'>
            <input type='hidden' name='return' value='<?php echo e(url('paypal/getCheckoutDetail')); ?>'> 
