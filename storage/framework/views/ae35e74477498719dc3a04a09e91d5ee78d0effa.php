						 ...
						 <thead>
						 	...
						 	<tbody>
						 		...
						 		<?php $__currentLoopData = $listDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							       ...
							       <td><?php echo e($detail->step); ?></td>
							       <td><?php echo e($detail->point); ?> </td> 
							        <td><?php echo e($detail->level_upgrade_point); ?> </td>
							         <td><?php echo e($detail->level_downline); ?> </td>
							       <td>
							       		<a class="btn btn-primary btn-sm" href="<?php echo e(url('administrator/edit-value-point/'.$detail->id)); ?>" title="modificare"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
							       </td>
						 ...
						 <thead>
						 	...
						 	<tbody>
						 		...
						 		<?php $__currentLoopData = $listDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							       ...
							       <td><?php echo e($detail->level_downline); ?> </td>
							       <td><?php echo e($detail->level_upgrade_point); ?> </td>
							      <td><?php echo e($detail->renuwal_account); ?> </td>
								  ...
								  elseif($i=='6'){echo 'BK8';}elseif($i=='7'){echo 'BK10';}elseif($i=='8'){echo 'BK12';}elseif($i=='9'){echo 'President';}elseif($i=='10'){echo 'President Team';}?></td>
								   ...
								   <td><?php echo e(!empty($detail->become_founder_euro)?$detail->become_founder_euro:'0'); ?> </td>

								     <td>
					                        <label class="switch"><input type="checkbox" id="togBtn" data-id="<?php echo e($detail->id); ?>" name="founder" value="" <?php echo e(($detail->level_founder_status=='1')?'checked':''); ?>><div class="slider round"></div></label>
