                        ...
                        <div class="breadcumb">
                            <ul>
                               ...
                               <span><i class="fa fa-angle-right" aria-hidden="true"></i></span>
                                ...
                                <span><i class="fa fa-angle-right" aria-hidden="true"></i></span>
                                <li><a class="current" href="#">Modificare documento</a></li>
						...
						<div class="form-body">
						 ...
						 <?php echo e(csrf_field()); ?>
							...
							<div class="form-group <?php echo e($errors->has('filename') ? ' has-error' : ''); ?>">
								 ...
								 <input type="text" title="Nome del file" class="form-control" id="filename" name="filename" value="<?php echo e(!empty($getDetail)?$getDetail->file_name:old('filename')); ?>" placeholder="Nome del file" value="<?php echo e(Session::get('name')); ?>">
							...
							<div class="form-group <?php echo e($errors->has('editor1') ? ' has-error' : ''); ?>">
								 ...
								 <textarea class="form-control" name="editor1"  placeholder="Descrizione"><?php echo e(old('editor1')); ?><?php echo e(!empty($getDetail)?$getDetail->description:''); ?></textarea>
							...
							<div class="form-group <?php echo e($errors->has('point_value') ? ' has-error' : ''); ?>">
								 ...
								 <input type="text" title="Punto Valore" class="form-control" id="point_value" value="<?php echo e(!empty($getDetail)?$getDetail->point_value:old('point_value')); ?>" name="point_value" placeholder="Eg. 23" value="<?php echo e(Session::get('point_value')); ?>">
							...
							<div class="form-group <?php echo e($errors->has('filetype') ? ' has-error' : ''); ?>">
								  ...
								  <select class="form-control" id="filetype" name="filetype" title="Seleziona Tipo">
								    ...
								    <option value="image" <?php if($getDetail->file_type == 'image'){ echo 'selected';} ?>>Immagine</option>
									<option value="video" <?php if($getDetail->file_type == 'video'){ echo 'selected';} ?>>Video</option>
									<option value="document" <?php if($getDetail->file_type == 'document'){ echo 'selected';} ?>>Documento</option>
							...
							<div class="form-group <?php echo e($errors->has('file') ? ' has-error' : ''); ?>">
								 ...
								 <?php if($errors->has('file')): ?>
                                   ...
                                   <input type="hidden" name="olde_value" value="<?php echo e($getDetail->file); ?>">
							</div>
