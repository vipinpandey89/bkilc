                            ...
                            <div class="row">
                             ...
                             <?php endif; ?>
                                    <form role="form" method="post" id="demo-form" data-parsley-validate enctype="multipart/form-data">
										...
										<div class="form-group">
										<div class="col-sm-6">
										<div class="<?php echo e($errors->has('telephoneNumber') ? ' has-error' : ''); ?>">
										...
										<div class="form-group">
										<div class="col-sm-6">
										<div class="<?php echo e($errors->has('resiaddress') ? ' has-error' : ''); ?>">
										...
										<div class="col-sm-6">
										<div class="<?php echo e($errors->has('region') ? ' has-error' : ''); ?>">
										...
										<div class="form-group">
										<div class="col-sm-6">
										<div class="<?php echo e($errors->has('postalCode') ? ' has-error' : ''); ?>">
										...
										<div class="col-sm-6">
										<div class="<?php echo e($errors->has('pariva') ? ' has-error' : ''); ?>">
