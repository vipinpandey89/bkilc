                    ...
                    <div class="col-md-4 text-right">
                        <div class="breadcumb">
                            <ul>
                                ...
                                <li><a href="#">Modello Aziendale</a></li>

                               <span><i class="fa fa-angle-right" aria-hidden="true"></i></span>
                                <li><a  href="<?php echo e(url('administrator/userlist')); ?>">Lista</a></li>

                                <span><i class="fa fa-angle-right" aria-hidden="true"></i></span>
                                <li><a class="current" href="#">Aggiungi Azienda</a></li>
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							...
							<div class="form-group <?php echo e($errors->has('businessname') ? ' has-error' : ''); ?>">
								 ...
								 <input type="text" class="form-control" id="exampleInputEmail1" name="businessname" value="<?php echo e(!empty($userProfile)?$userProfile->userName:old('businessname')); ?>" placeholder="Nome della ditta" maxlength="30">
							...
							<div class="form-group<?php echo e($errors->has('telephoneNumber') ? ' has-error' : ''); ?>">
								 ...
								 <input type="text" class="form-control" id="exampleInputEmail1" min="1" max="10" name="telephoneNumber"  value="<?php echo e(!empty($userProfile)?$userProfile->telephoneNumber:old('telephoneNumber')); ?>" placeholder="Telephone Number">
							...
							<div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
								 ...
								 <input type="email" class="form-control" id="exampleInputEmail1" name="email" value="<?php echo e(!empty($userProfile)?$userProfile->email:old('email')); ?>"  placeholder="E-Mail Address">
							...
							<div class="form-group<?php echo e($errors->has('address') ? ' has-error' : ''); ?>">
								 ...
								 <input type="text" class="form-control" id="adr" name="address"  value="<?php echo e(!empty($userProfile)?$userProfile->telephoneNumber:old('address')); ?>" placeholder="Indirizzo">
							...
							<div class="form-group<?php echo e($errors->has('city') ? ' has-error' : ''); ?>">
								 ...
								 <input type="text" class="form-control" id="city" name="city"  value="<?php echo e(!empty($userProfile)?$userProfile->telephoneNumber:old('city')); ?>" placeholder="Città">
							...
							<div class="form-group<?php echo e($errors->has('state') ? ' has-error' : ''); ?>">
								 ...
								 <input type="text" class="form-control" id="state" name="state"  value="<?php echo e(!empty($userProfile)?$userProfile->telephoneNumber:old('state')); ?>" placeholder="Stato">
							...
							<div class="form-group<?php echo e($errors->has('postalCode') ? ' has-error' : ''); ?>">
								 ...
								 <input type="text" class="form-control" id="zip" name="postalCode" value="<?php echo e(!empty($userProfile)?$userProfile->postalCode:old('postalCode')); ?>" placeholder="Postal Code">
