                ...
                <?php endif; ?>
					<div class="panel panel-primary">
					  ...
					  <div class="panel-body">
						...
						<a href="<?php echo e(url('administrator/addcompany')); ?>" class="btn btn-primary" style="display: inline-block;margin-bottom: 20px;">Aggiungi Azienda</a>						
						 		...
						 		<?php $__currentLoopData = $getDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							       ...
							       <td><div class="user-avatar">
				                        <a class="chlid">
				                           ...
				                           <img src="<?php echo e(url('images/dealer_logos/'.$Detail->logo)); ?>"> 
				                           <?php else: ?>
							       ...
							       <td>	<?php echo e($Detail->business_name); ?></td>
							        <td>	<?php echo e($Detail->phone); ?></td>
							         <td>	<?php echo e($Detail->postcode); ?></td>
							          <td>	<?php echo e($Detail->email); ?></td>
							        <td>						        
							        	

							       <a class="btn btn-info btn-sm" href="<?php echo e(url('administrator/edit-company/'.$Detail->id)); ?>" title="modificare"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
							      <a class="btn btn-danger btn-sm" href="<?php echo e(url('administrator/delete-company/'.$Detail->id)); ?>" title="Elimina" onclick="return confirm('Sei sicuro di voler eliminare questo')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
