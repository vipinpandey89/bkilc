                                    ...
                                    <form role="form" method="post" action="<?php echo e($paypalUrl); ?>"  id="demo-form" data-parsley-validate>
                                        ...
                                        <table class="table table-striped table-hover table-green table-bordered">
												...
												<tbody>
													...
													<?php if($deadline1 >= $currentdate): ?>
													
	                                                <?php if($userProfile->payment_status == 1): ?>
													<?php 
														$st = 'enabled';
													 ?>	
													<?php else: ?>
													...
													<?php endif; ?> 
													   <td><span class="label label-info"><?php echo e(!empty($dateString)? date('d-m-Y',strtotime($dateString)):''); ?></span></td>
													   <td><span style="font-size: 24px;font-weight: bold;" class="superscript text-success">&euro;</span>
													<span style="font-size: 24px;font-weight: bold;" class="text-success"><?php echo e(!empty($planGetById)?$planGetById->subscription_price:old('subscription_price')); ?></span></td>
													   <td><span class="label label-danger"><?php if(!empty($deadline)): ?><?php echo e(date('d-m-Y', strtotime($deadline))); ?> <?php endif; ?></span></td>
													</tr> 
                                        ...
                                        <input type="hidden" id="amount" name="amount" value="<?php echo e(!empty($planGetById)?$planGetById->subscription_price:old('subscription_price')); ?>">
                                        <input type="hidden" name="currency_code" value="EUR">    
                                        <input type="hidden" name="custom" id="custom" value="">                                        
                                        <input type='hidden' name='cancel_return' value='<?php echo e(url('paypal/dealer-cancel')); ?>'>
                                        <input type='hidden' name='return' value='<?php echo e(url('paypal/dealer-getupgradecommission')); ?>'> 
