        ...
        <div id="page-wrapper" >
			...
			<div class="col-md-2">
			  ...
			  <div class="vertical-pipes custom-box">
                <h5>Ipsum</h5>
				<p><?php echo e(($userProfile->total_wallet > 0)?$userProfile->total_wallet:'0'); ?></p>
				<p class="big-f">P.V</p>
			  </div>
			  </div>
			</div>
			...
			<div class="panel panel-default">
			  ...
			  <div class="vertical-pipes custom-box">
				<h5>Ipsum</h5>
				<p><?php echo e(($userProfile->founder_bonus_point_value > 0)?$userProfile->founder_bonus_point_value:'0'); ?></p>
				<p class="big-f">P.V</p>
			  </div>
			  </div>
			</div>
