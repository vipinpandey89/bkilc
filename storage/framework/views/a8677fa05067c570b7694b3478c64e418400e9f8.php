...
<div id="Banner_wrapper" class="bg-parallax banner_wrapper" style="background-image:url(<?php echo e(url('website/images/home-page.jpg')); ?>);">
...
<!--- VIDEO SECTION HOME  --->
 <div id="video_section" class="section">
  ...
  <div class="icon_box"><a href="<?php echo e(url('affiliati-gratis')); ?>"><div class="image_wrapper"><img src="<?php echo e(url('website/images/home_meeting_pic1-1-1.png')); ?>" class="img-responsive" alt="" width="" height=""></div>
...
Unisciti a noi per costruire il più grande circuito commerciale e la più grande <b>COMUNITÀ </b>d’Italia </div></div></a></div>
  ...
  <div class="col-lg-4 col-md-4 col-sm-4">
  <div class="icon_box"><a href="<?php echo e(url('lavora-con-noi')); ?>"><div class="image_wrapper"><img src="<?php echo e(url('website/images/home_meeting_pic2-1.png')); ?>" class="img-responsive" alt="" width="" height=""></div><div class="desc_wrapper"><h4 class="title">Lavora con noi</h4><div class="desc">Bklic, un progetto <b>UNICO </b>che ti dà la possibilità di essere protagonista in un grande mercato già <b>RICCO </b>ma in fortissima <b>CRESCITA </b>nei prossimi anni.</div></div></a></div>
  
  </div>
  
  <div class="col-lg-4 col-md-4 col-sm-4">
  <div class="icon_box"><a href="<?php echo e(url('bklic-card')); ?>"><div class="image_wrapper"><img src="<?php echo e(url('website/images/home_meeting_pic3-1-1.png')); ?>" class="scale-with-grid" alt="" width="" height=""></div><div class="desc_wrapper"><h4 class="title">Risparmia con la card</h4><div class="desc">Mia <b>NONNA </b>diceva: un centesimo <b>RISPARMIATO </b>è un centesimo <b>GUADAGNATO</b>. Scopri quanto è semplice risparmiare sulla spesa di tutti i giorni.</div></div></a></div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12">
                   <div class="row image_frame">
                       <div class="image_wrapper">
                        <img src="<?php echo e(url('website/images/chisiamo.jpg')); ?>" class="img-responsive" alt="">
                       </div>
                   </div>
               </div>
               ...
               <div class="col-lg-6 col-md-6 col-sm-12">
                   <div class="row text_frame">
                       <div class="text_wrapper">
                           ...
                           <a href="<?php echo e(url('chi-siamo')); ?>"  class="button_label">Scopri di più <i class="fa fa-thumbs-up" aria-hidden="true"></i></a>
           ...
           <div class="col-lg-6 col-md-6 col-sm-12">
               <div class="row text_frame">
                   <div class="text_wrapper">
                       ...
                       <a href="<?php echo e(url('opportunita')); ?>" class="button_label">Scopri di più <i class="fa fa-thumbs-up" aria-hidden="true"></i></a>
                   </div>
               </div>
           </div>
           <div class="col-lg-6 col-md-6 col-sm-12">
               <div class="row image_frame">
                   <div class="image_wrapper">
                    <img src="<?php echo e(url('website/images/Bklic-1.jpg')); ?>" class="img-responsive" alt="">
                   </div>
               </div>
           </div>
       </div>
   ...
   <div class="container-fluid">
       <div class="row">
           <div class="col-lg-6 col-md-6 col-sm-12">
               <div class="row image_frame">
                   <div class="image_wrapper">
                    <img src="<?php echo e(url('website/images/home-mission.jpg')); ?>" class="img-responsive" alt="">
                   </div>
               </div>
           </div>
           ...
           <div class="col-lg-6 col-md-6 col-sm-12">
               <div class="row text_frame">
                   <div class="text_wrapper">
                       ...
                       <a href="<?php echo e(url('mission')); ?>"  class="button_label">Scopri di più <i class="fa fa-thumbs-up" aria-hidden="true"></i></a>
           ...
           <div class="col-lg-6 col-md-6 col-sm-12">
               <div class="row text_frame">
                   <div class="text_wrapper">
                       ...
                       <a href="<?php echo e(url('career-and-gains')); ?>" class="button_label">Scopri di più <i class="fa fa-thumbs-up" aria-hidden="true"></i></a>
                   </div>
               </div>
           </div>
           <div class="col-lg-6 col-md-6 col-sm-12">
               <div class="row image_frame">
                   <div class="image_wrapper">
                    <img src="<?php echo e(url('website/images/home-carriera-e-guadagni-1500.jpg')); ?>" class="img-responsive" alt="">
                   </div>
               </div>
           </div>
       </div>
