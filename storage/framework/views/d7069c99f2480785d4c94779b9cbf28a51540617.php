...
<div id="Banner_wrapper" class="bg-parallax category-news" style="background-image:url(<?php echo e(url('website/images/fascione-news.jpg')); ?>);">
  <div id="Subheader">
   <div class="container">
      ...
      <div class="row">
            ...
            <?php $__currentLoopData = $getnews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newsDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="post-item isotope-item clearfix">
                    <div class="date_label"><?php echo e(date('d-m-Y',strtotime($newsDetail->created_at))); ?></div>

                    <?php if(!empty($newsDetail->image)): ?>
                    <div class="image_frame post-photo-wrapper image">
                      <div class="image_wrapper">
                        <a href="<?php echo e(url('news-detail/'.$newsDetail->id)); ?>">
                    ...
                    <div class="post-desc-wrapper">
                      <div class="post-desc">
                        <div class="post-title">
                          <h2 class="entry-title"><a href="<?php echo e(url('news-detail/'.$newsDetail->id)); ?>"><?php echo e($newsDetail->title); ?></a></h2>
                        </div>
                        <div class="post-excerpt"><p class="big"><?php echo e(strip_tags(substr($newsDetail->description,0,200))); ?></p></div>
                        <div class="post-footer">
                          <div class="post-links"><i class="fa fa-file-text-o"></i> <a href="<?php echo e(url('news-detail/'.$newsDetail->id)); ?>" class="post-more">Leggi di più</a></div></div>
                        </div>
                      </div>
