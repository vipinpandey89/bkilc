...
?>
  ...
  <hr />
	   ...
	   <div class="stats">
	   <h5><?php echo e(!empty($countChildPromoter)?$countChildPromoter:'0'); ?></h5> 
	   ...
	   <div class="stats">
	   <h5><?php echo e(!empty($dashBoardData['AffiliatesData'])?$dashBoardData['AffiliatesData']:'0'); ?></h5> 
	   ...
	   <div class="stats">
	   <h5><?php echo e(!empty($dashBoardData['cardUser'])?$dashBoardData['cardUser']:'0'); ?></h5> 
	   ...
	   <!--<div class="col-md-12">
	    <div class="card_btn sub_title"><a href="javascript:void()">Ancora <span><?php echo e(($remaningdownline > 0)?$remaningdownline:'0'); ?></span>  Linee per L'upgrade!</a></div>
	   </div>-->
	   ...
	   <div class="stats">
	   <h5><?php echo e(!empty($dashBoardData['GetCommissionUserCurrentMonth'])?round($dashBoardData['GetCommissionUserCurrentMonth'],2):'0'); ?><sup>P.V.</sup></h5> 
	   ...
	   <div class="stats">
	   <h5><?php echo e(!empty($dashBoardData['GetCommissionUserPreviousMonth'])?round($dashBoardData['GetCommissionUserPreviousMonth'],2):'0'); ?><sup>P.V.</sup></h5> 
            ...
            <!--<div class="col-md-4 col-sm-4">           
              <div class="panel panel-back noti-box">
                ...
                <div class="panel_header">
                  <h3><i class="fa fa-user" aria-hidden="true"></i>  <?php echo e(!empty($userProfile)?$userProfile->name:''); ?></h3>  
                </div>

                <ul class="user_name_list">
                  <li><span><?php echo e(!empty($countChildPromoter)?$countChildPromoter:'0'); ?></span> <a href="#"> In Prima Linea</a></li>

                  <li><span><?php echo e(!empty($dashBoardData['AffiliatesData'])?$dashBoardData['AffiliatesData']:'0'); ?></span> <a href="#"> Affiliati</a></li>

                  <li><span><?php echo e(!empty($dashBoardData['cardUser'])?$dashBoardData['cardUser']:'0'); ?></span> <a href="#"> Card Vendute</a></li>

                </ul>

                <div class="card_btn"><a href="javascript:void()">Ancora <span><?php echo e(($remaningdownline > 0)?$remaningdownline:'0'); ?></span>  Linee per L'upgrade!</a></div>
               ...
               <div class="row">
                <div class="col-xs-12">
                  <div class="data-cal">
                    ...
                    <div class="data-val color-blue"><p><?php echo e(!empty($dashBoardData['GetCommissionUserCurrentMonth'])?round($dashBoardData['GetCommissionUserCurrentMonth'],2):'0'); ?><sup>P.V.</sup></p></div>
                  </div>

                  <div class="data-cal">
                    <div class="data-label">MESE PRECEDENTE</div>
                    <div class="data-val"><p><?php echo e(!empty($dashBoardData['GetCommissionUserPreviousMonth'])?$dashBoardData['GetCommissionUserPreviousMonth']:'0'); ?><sup>P.V.</sup></p></div>
                  </div>
        ...
        <div class="row">
          <div class="col-md-12"> 
			...
			<div class="news">
                    ...
                    <?php if(!empty($dashBoardData['allNewsEvents'])): ?>
                      <?php $__currentLoopData = $dashBoardData['allNewsEvents']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					  ...
					  <div class="media">
							...
							<h4 class="media-heading"><?php echo e($data->title); ?>.</h4>
							<label class="label label-warning"><a href="#"><?php echo e(date('d-m-Y',strtotime($data->created_at))); ?></a></label>
                ...
                <div class="col-sm-12">
                  ...
                  <div class="news">
                    ...
                    <ul class="list-inline">
                      <li class="list-inline-item"><div class="card_btn"><a href="#"><?php echo e(date('d-m-Y',strtotime($data->created_at))); ?></a></div></li>
                      <li class="list-inline-item"><p><?php echo e($data->title); ?>. </p></li>
                    </ul>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
