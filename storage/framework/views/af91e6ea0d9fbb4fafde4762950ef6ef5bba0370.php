                      ...
                      <td width="100" class="mobile" align="center" valign="top" style="padding: 0 10px 0 0">
                        <div class="qr_code" style=" height: 200px; width: 199px; border:1px solid #000;padding: 15px;">
                            <?php if(!empty($data->profileimage)){?>
                               <img style="width: 209px;height: 196px;" src="<?php echo e(url('images/profile_images/'.$data->profileimage)); ?>">
                               <?php }else{?>
                                <img style="width: 209px;height: 196px;" src="<?php echo e(url('front/assets/img/find_user.png')); ?>">
                               <?php }?> 
                          </div>
                      </td>
                      <td width="300" class="mobile" align="center" valign="top" style="padding: 0 0px 0 10px;">
                        <div class="card-box">
                          <table width="100%">
                            <tr>
                                <td>Nome</td>
                                <td><div class="name-field"><?php echo e($data->name); ?></div></td>
                              </tr>
                              <tr>
                                <td>Cognome</td>
                                <td><div class="name-field"><?php echo e($data->userName); ?></div></td>
                              </tr>
                              <tr>
