                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input name="textfiled" value="<?php echo e($data->userName); ?>" type="text" style=" border: none; border-bottom-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; outline:none; width:90%;">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input name="textfiled" value="<?php echo e($data->name); ?>" type="text" style=" border: none; border-bottom-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; outline:none; width:100%;">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td style="width:500px;">
                                                                    <input name="textfiled2" value="<?php echo e(date('d-m-Y',strtotime($data->dob))); ?>" type="text" style=" border: none; border-bottom-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; outline:none; width:100%;">
                                                                </td>
                                                                <!-- <td>( -->
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input name="textfiled" type="text" value="<?php echo e($data->region); ?>" style=" border: none; border-bottom-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; outline:none; width:90%;">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input name="textfiled" type="text" value="<?php echo e($data->postalCode); ?>" style=" border: none; border-bottom-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; outline:none; width:100%;">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input name="textfiled" value="<?php echo e($data->pariva); ?>" type="text" style=" border: none; border-bottom-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; outline:none; width:95%;">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input name="textfiled" type="text"  style=" border: none; border-bottom-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; outline:none; width:100%;">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input name="textfiled" type="text" value="<?php echo e($data->fcode); ?>" style=" border: none; border-bottom-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; outline:none; width:90%;">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input name="textfiled" type="text" value="<?php echo e($data->pariva); ?>" style=" border: none; border-bottom-width: 1px; border-bottom-color: #000000; border-bottom-style: solid; outline:none; width:100%;">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                  ...
                                  <button  onclick="javascript:window.print()" class="btn-print">Salva</button>
                                   <input type="button" value="Stampa" onClick="location.href=location.href">
                                </td>
                            </tr>
