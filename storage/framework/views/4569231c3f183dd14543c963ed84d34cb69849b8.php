...
<div class="col-md-6">
  <div class="form-group form-group<?php echo e($errors->has('Fcode') ? ' has-error' : ''); ?>">
    ...
    <input id="Fcode" type="text" class="form-control" name="Fcode" value="<?php echo e(!empty($userProfile->fcode)?$userProfile->fcode: old('Fcode')); ?>" required>
...
<div class="col-md-6">
 <div class="form-group form-group<?php echo e($errors->has('business_name') ? ' has-error' : ''); ?>">
  ...
  <input id="business_name" type="text" class="form-control" name="business_name" value="<?php echo e(!empty($userProfile->business_name)?$userProfile->business_name: old('business_name')); ?>" required>
