			...
			<div class="main-page">
			  ...
			  <?php if(Session::has('success')): ?>
				...
				<!--	<a href="<?php echo e(url('administrator/addconvertion')); ?>" class="btn btn-primary" style="">Aggiungi conversione</a>-->
                  ...
                  <?php $i=1; ?>
                <?php $__currentLoopData = $getConvertion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <tr>
                     ...
                     <td><?php  if($user->convertion_title=='2'){echo 'BK0 conversione';}elseif($user->convertion_title=='3'){echo 'BK2 conversione';}elseif($user->convertion_title=='4'){echo 'BK4 conversione';}elseif($user->convertion_title=='5'){echo 'BK6 conversione';}elseif($user->convertion_title=='6'){echo 'BK8 conversione';}elseif($user->convertion_title=='7'){echo 'BK10 conversione';}elseif($user->convertion_title=='8'){echo 'BK12 conversione';}elseif($user->convertion_title=='9'){echo 'P conversione'; }elseif($user->convertion_title=='10'){echo 'PT conversione'; }elseif($user->convertion_title=='11'){echo 'PE conversione'; } ?></td>
                      ...
                      <td><?php echo e($user->convertion_pv); ?></td> 

                     <td> &euro;<?php echo e($user->convertion_euro); ?></td> 
                 
                    
                   
                          <td>
                        
                        <a class="btn btn-info btn-sm" href="<?php echo e(url('administrator/edit-convertion/'.$user->id)); ?>" title="modificare"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>

                       <!-- <a class="btn btn-danger btn-sm" href="<?php echo e(url('administrator/deleteconvertion/'.$user->id)); ?>" title="Elimina" onclick="return confirm('Sei sicuro di voler cancellare questo ?')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>-->
