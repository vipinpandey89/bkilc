		...
		<div id="page-wrapper">
			<div class="main-page">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							...
							<div class="form-group <?php echo e($errors->has('title') ? ' has-error' : ''); ?>">
								 ...
								 <input type="text" class="form-control" id="exampleInputEmail1" name="title" value="<?php echo e(!empty($getEditDetail)?$getEditDetail->title:old('title')); ?>" placeholder="Nome della ditta" maxlength="30">
              ...
              <div class="form-group ">
                ...
                <textarea class="form-control" name="editor1" placeholder="Descrizione"><?php echo e(!empty($getEditDetail)?$getEditDetail->description:old('editor1')); ?></textarea>
              ...
              <div class="form-group <?php echo e($errors->has('file') ? ' has-error' : ''); ?>">
                 ...
                 <input type="file" class="form-control" id="exampleInputEmail1" name="file"  placeholder="Nome della ditta" maxlength="30">
                  ...
                  <input type="hidden" name="old_image" value="<?php echo e($getEditDetail->image); ?>">

                  <?php if(!empty($getEditDetail->image)): ?>
                  <img src="<?php echo e(url('images/news/'.$getEditDetail->image)); ?>" style="width: 100px;height: 100px;">
                  <?php endif; ?>
