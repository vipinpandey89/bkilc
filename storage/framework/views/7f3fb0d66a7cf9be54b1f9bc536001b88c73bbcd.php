...
<?php $__env->startSection('content'); ?>
        ...
        <div class="row">
			  ...
			  <?php if(Session::has('success')): ?>
                ...
                ?>
						 		<?php $__currentLoopData = $getUserPayment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $getUser = Helper::getUserByUserId($user->checkoutparentid);
                 ?>
							       ...
							       <td><?php echo e(($user->paymentstatus)?$user->paymentstatus:'Free'); ?></td> 
                     ...
                     <td><?php echo e(!empty($user->paymentDate)?date('d-m-Y',strtotime($user->paymentDate)):'-'); ?></td>
                      <td><?php echo e(!empty($user->expiry_date)?date('d-m-Y',strtotime($user->expiry_date)):'-'); ?></td>
