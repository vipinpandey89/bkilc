                      ...
                      <td><div class="user-avatar">
                        <a class="chlid" data-id="<?php echo e($user->id); ?>">
                           ...
                           <?php endif; ?>
							       ...
							       <td><?php echo e(!empty($user->promoter_percentage)?$user->promoter_percentage.'%':'-'); ?></td>
                      <td><?php echo e(!empty($user->bklic_profit)?'&euro;'.$user->bklic_profit:'-'); ?></td>

							        <td>

							        	<a class="btn btn-info btn-sm" href="<?php echo e(url('administrator/editbonus/'.$user->id)); ?>" title="modificare"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>						        
