				...
				<div class="panel panel-primary">
				  ...
				  <div class="panel-body">
					<div class="table-responsive">
						<a href="<?php echo e(url('administrator/addElearningdocs')); ?>" class="btn btn-primary" style="display:inline-block;margin-bottom:20px;">Aggiungi documento</a>
						 ...
						 <thead>
						 	...
						 	<tbody>
								...
								?>
							       ...
							       <a class="btn btn-primary btn-sm" href="<?php echo e(url('administrator/viewdoc/'.$doc->id)); ?>"  title="vista"><i class="fa fa-eye" aria-hidden="true"></i></a>

							      <!--  <a class="btn btn-info btn-sm" href="<?php echo e(url('administrator/edit-elearning/'.$doc->id)); ?>" title="modificare"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> -->

							       <a class="btn btn-danger btn-sm" href="<?php echo e(url('administrator/deleteelearning/'.$doc->id)); ?>" title="Elimina" onclick="return confirm('Sei sicuro di voler eliminare questo file')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
